...
import { FaBars, FaTachometerAlt, FaDatabase, FaChartBar, FaNetworkWired, FaFileAlt, FaSearch, FaUsersCog, FaCog, FaCheckCircle } from "react-icons/fa";
  ...
  return (
    <nav className={`sidebar ${sidebarOpen ? "" : "collapsed"}`}>
      ...
      <ul className="menu-list">
        ...
        <li><Link to="/search"><FaSearch /><span className="menu-text">Search</span></Link></li>
        ...
        <li><Link to="/settings"><FaCog /><span className="menu-text">Settings</span></Link></li>
      </ul>
    </nav>
  );
};
